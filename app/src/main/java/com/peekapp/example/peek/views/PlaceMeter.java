 ...
 */
public class PlaceMeter extends View implements View.OnClickListener{
    ...
    public PlaceMeter(Context context) {
        this(context, null);
    }

    public PlaceMeter(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public void setMediaDialog(MediaDialog mDialog) {
    ...
    public void onClick(View v) {
        if (mDialog != null) {
            mDialog.show();
            ImageView dialogImage = (ImageView) mDialog.findViewById(R.id.dialogImage);
            dialogImage.setOnLongClickListener(new View.OnLongClickListener() {
                @Override
