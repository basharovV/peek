...
import com.peekapps.peek.data.exception.GoogleAPIConnectionException;
import com.peekapps.peek.data.exception.GoogleAPIConnectionSuspendedException;
 ...
 */
public abstract  class GoogleApiObservable <T> implements Observable.OnSubscribe<T> {
    private final Context ctx;
    private final List<Api<? extends Api.ApiOptions.NotRequiredOptions>> services;

    @SafeVarargs
    protected GoogleApiObservable(Context ctx, Api<? extends Api.ApiOptions.NotRequiredOptions>... services) {
        this.ctx = ctx;
